...
|--------|---------|----------------|-------|----------------|----------------------------|
| admin | PARTIAL | 72 | 1 | 3 | fake_data=72 |
| ai | PARTIAL | 31 | 1 | 4 | fake_data=31 |
| analytics | PARTIAL | 0 | 0 | 0 | no tests |
| api-analytics | STUB | 0 | 0 | 0 | no endpoints |
| api-platform | PARTIAL | 14 | 0 | 0 | fake_data=14 |
| auth | PARTIAL | 55 | 2 | 0 | fake_data=55 |
| automation | STUB | 0 | 0 | 0 | no endpoints |
| background-jobs | PARTIAL | 0 | 0 | 0 | no tests |
| billing | PARTIAL | 32 | 1 | 0 | fake_data=32 |
| branches | PARTIAL | 0 | 0 | 0 | no tests |
| broker | PARTIAL | 0 | 0 | 0 | no tests |
| chat | PARTIAL | 0 | 0 | 0 | no tests |
| comments | PARTIAL | 0 | 0 | 0 | no tests |
| commercial | PARTIAL | 0 | 0 | 0 | no tests |
| common | STUB | 1 | 0 | 0 | fake_data, no endpoints |
| communications | PARTIAL | 39 | 0 | 0 | fake_data=39 |
| companies | WORKING | 0 | 0 | 0 | curl -s /api/v1/companies |
| config | STUB | 0 | 0 | 0 | no endpoints |
| crm | PARTIAL | 0 | 0 | 0 | no tests |
| customers | PARTIAL | 0 | 0 | 0 | no tests |
| dashboard | PARTIAL | 5 | 0 | 0 | fake_data=5 |
| data-lifecycle | STUB | 0 | 0 | 0 | no endpoints |
| data | PARTIAL | 0 | 0 | 0 | no tests |
| developer | PARTIAL | 0 | 0 | 0 | no tests |
| dispatch | PARTIAL | 31 | 1 | 1 | fake_data=31 |
| documents | PARTIAL | 29 | 0 | 0 | fake_data=29 |
| drivers | PARTIAL | 36 | 1 | 0 | fake_data=36 |
| dto | STUB | 0 | 2 | 0 | no endpoints |
| edi | STUB | 0 | 0 | 0 | no endpoints |
| exports | PARTIAL | 2 | 0 | 0 | fake_data=2 |
| factoring | PARTIAL | 0 | 0 | 0 | no tests |
| fastag | PARTIAL | 0 | 0 | 0 | no tests |
| finance | PARTIAL | 0 | 0 | 0 | no tests |
| fleet | PARTIAL | 0 | 0 | 0 | no tests |
| fuel | STUB | 0 | 0 | 0 | no endpoints |
| gst | PARTIAL | 0 | 0 | 0 | no tests |
| health | PARTIAL | 0 | 0 | 0 | no tests |
| iam | PARTIAL | 25 | 0 | 1 | fake_data=25 |
| integration | PARTIAL | 53 | 2 | 0 | fake_data=53 |
| integrations | PARTIAL | 8 | 1 | 0 | fake_data=8 |
| intelligence | PARTIAL | 6 | 0 | 0 | fake_data=6 |
| invoices | PARTIAL | 0 | 0 | 0 | no tests |
| ledger | PARTIAL | 0 | 0 | 0 | no tests |
| lifecycle | STUB | 0 | 0 | 0 | no endpoints |
| loads | PARTIAL | 0 | 0 | 0 | no tests |
| localization | PARTIAL | 0 | 0 | 0 | no tests |
| lorry-receipts | PARTIAL | 0 | 0 | 0 | no tests |
| maintenance | PARTIAL | 0 | 0 | 0 | no tests |
| marketplace | PARTIAL | 0 | 0 | 0 | no tests |
| mobile | PARTIAL | 0 | 0 | 0 | no tests |
| operations | PARTIAL | 0 | 0 | 12 | no tests |
| optimization | PARTIAL | 10 | 0 | 0 | fake_data=10 |
| payments | PARTIAL | 0 | 0 | 0 | no tests |
| planning | PARTIAL | 0 | 0 | 0 | no tests |
| platform | PARTIAL | 56 | 0 | 2 | fake_data=56 |
| plugins | STUB | 0 | 0 | 0 | no endpoints |
| portals | WORKING | 0 | 1 | 0 | curl -s /api/v1/portals/support-tickets |
| prisma | STUB | 0 | 0 | 0 | no endpoints |
| profitability | PARTIAL | 0 | 0 | 0 | no tests |
| reporting | PARTIAL | 4 | 0 | 0 | fake_data=4 |
| reports | PARTIAL | 0 | 0 | 0 | no tests |
| roles | PARTIAL | 0 | 0 | 0 | no tests |
| saas | PARTIAL | 1 | 0 | 0 | fake_data=1 |
| sandbox | PARTIAL | 3 | 0 | 0 | fake_data=3 |
| sdk | PARTIAL | 2 | 0 | 0 | fake_data=2 |
| search | PARTIAL | 1 | 0 | 0 | fake_data=1 |
| simulator | PARTIAL | 2 | 0 | 0 | fake_data=2 |
| support | PARTIAL | 0 | 0 | 0 | no tests |
| telemetry | STUB | 0 | 0 | 0 | no endpoints |
| tracking | PARTIAL | 40 | 0 | 0 | fake_data=40 |
| trailers | PARTIAL | 0 | 0 | 0 | no tests |
| trips | PARTIAL | 42 | 1 | 0 | fake_data=42 |
| users | PARTIAL | 0 | 0 | 0 | no tests |
| vehicles | PARTIAL | 0 | 0 | 0 | no tests |
| vendors | PARTIAL | 0 | 0 | 0 | no tests |
| warehouse | PARTIAL | 1 | 0 | 0 | fake_data=1 |
| wms | PARTIAL | 0 | 0 | 0 | no tests |
| workflow | PARTIAL | 51 | 3 | 0 | fake_data=51 |
| workspace | PARTIAL | 0 | 0 | 0 | no tests |
| yard | PARTIAL | 0 | 0 | 0 | no tests |
