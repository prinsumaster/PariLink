INSERT INTO "Company" (id, name, plan, "createdAt", "updatedAt") VALUES ('bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb', 'Tenant B', 'ENTERPRISE', NOW(), NOW()) ON CONFLICT DO NOTHING;
...
INSERT INTO "MaintenanceJob" (id, type, status, "startDate", "endDate", "labourCost", "vehicleId", "companyId", "createdAt", "updatedAt") 
VALUES ('mmmmmmmm-mmmm-4mmm-mmmm-mmmmmmmmmmmm', 'PREVENTIVE', 'COMPLETED', NOW(), NOW(), 1000, 'vvvvvvvv-vvvv-4vvv-vvvv-vvvvvvvvvvvv', 'bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb', NOW(), NOW()) ON CONFLICT DO NOTHING;
INSERT INTO "Tyre" (id, brand, "serialNumber", status, position, "vehicleId", "companyId", "createdAt", "updatedAt") 
VALUES ('yyyyyyyy-yyyy-4yyy-yyyy-yyyyyyyyyyyy', 'MRF', 'SN-BB', 'ACTIVE', 'FL', 'vvvvvvvv-vvvv-4vvv-vvvv-vvvvvvvvvvvv', 'bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb', NOW(), NOW()) ON CONFLICT DO NOTHING;
