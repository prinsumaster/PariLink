...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-semibold text-slate-900 dark:text-slate-100 text-sm tracking-tight leading-snug group-data-[size=sm]/card:text-xs",
        className
      )}
      {...props}
    />
