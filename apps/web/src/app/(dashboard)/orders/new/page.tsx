    ...
    <RoleGuard allowedRoles={['SUPER_ADMIN', 'ORG_ADMIN', 'DISPATCHER', 'OPERATIONS']}>
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-5xl mx-auto">
        <div>
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white">Create Order</h1>
          <p className="text-base font-medium text-slate-500 dark:text-slate-400 mt-1">Register a new customer shipment and freight manifest.</p>
        </div>
