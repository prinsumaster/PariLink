  ...
  if (isError || !trip) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-1 text-base font-medium text-slate-500">The trip you are looking for does not exist or you don't have access.</p>
        <div className="mt-6">
          <Link href="/trips" className="text-blue-600 hover:text-blue-500">
            &larr; Back to Trips
          </Link>
        </div>
      </div>
