...
export default function payrollPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Manage Payroll Runs</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
            <p>Loading...</p>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>periodStart</TableHead>
                  <TableHead>periodEnd</TableHead>
              ...
              <TableBody>
                {data.map((item: any) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell>{String(item.periodStart || '-')}</TableCell>
                    <TableCell>{String(item.periodEnd || '-')}</TableCell>
