    ...
    <div className="flex flex-col h-full page-enter">
      <div className="px-6 py-5 border-b border-border bg-background/80 backdrop-blur-sm shrink-0">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground">Outbound Orders</h1>
            <p className="text-sm text-muted-foreground mt-1">Manage dispatch and order picking</p>
          </div>
        ...
        <div className="mt-4 relative max-w-sm">
          ...
          <input
            type="text"
            placeholder="Search order or load ID..."
            value={search}
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar px-6 py-5 space-y-4">
        ...
        {/* Mock Data Item */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-border bg-card hover:border-violet-500/50 transition-colors">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">OUT-1001</span>
                <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-amber-500/10 text-amber-500 tracking-wider">
                  PENDING_PICK
                </span>
              </div>
              <div className="flex items-center gap-3 text-sm text-muted-foreground mt-1">
                <span className="flex items-center gap-1"><Clock className="h-3.5 w-3.5"/> Needed by: Tomorrow</span>
