...
-- RLS for OptimizationWeightConfig
ALTER TABLE "OptimizationWeightConfig" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "OptimizationWeightConfig" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "OptimizationWeightConfig";
CREATE POLICY "tenant_isolation_policy" ON "OptimizationWeightConfig"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for OptimizationFeedback
ALTER TABLE "OptimizationFeedback" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "OptimizationFeedback" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "OptimizationFeedback";
CREATE POLICY "tenant_isolation_policy" ON "OptimizationFeedback"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "CrmLead";
CREATE POLICY "tenant_isolation_policy" ON "CrmLead"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "CrmActivity";
CREATE POLICY "tenant_isolation_policy" ON "CrmActivity"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "SalesTarget";
CREATE POLICY "tenant_isolation_policy" ON "SalesTarget"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for GstTaxRule
ALTER TABLE "GstTaxRule" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "GstTaxRule" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "GstTaxRule";
CREATE POLICY "tenant_isolation_policy" ON "GstTaxRule"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for TaxLedger
ALTER TABLE "TaxLedger" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "TaxLedger" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "TaxLedger";
CREATE POLICY "tenant_isolation_policy" ON "TaxLedger"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for TollAccount
ALTER TABLE "TollAccount" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "TollAccount" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "TollAccount";
CREATE POLICY "tenant_isolation_policy" ON "TollAccount"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for TollTransaction
ALTER TABLE "TollTransaction" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "TollTransaction" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "TollTransaction";
CREATE POLICY "tenant_isolation_policy" ON "TollTransaction"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "BankAccount";
CREATE POLICY "tenant_isolation_policy" ON "BankAccount"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for BankStatement
ALTER TABLE "BankStatement" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "BankStatement" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "BankStatement";
CREATE POLICY "tenant_isolation_policy" ON "BankStatement"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for BankTransaction
ALTER TABLE "BankTransaction" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "BankTransaction" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "BankTransaction";
CREATE POLICY "tenant_isolation_policy" ON "BankTransaction"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for VehiclePermit
ALTER TABLE "VehiclePermit" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "VehiclePermit" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "VehiclePermit";
CREATE POLICY "tenant_isolation_policy" ON "VehiclePermit"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for PayrollStructure
ALTER TABLE "PayrollStructure" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "PayrollStructure" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "PayrollStructure";
CREATE POLICY "tenant_isolation_policy" ON "PayrollStructure"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "PayrollRun";
CREATE POLICY "tenant_isolation_policy" ON "PayrollRun"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "Payslip";
CREATE POLICY "tenant_isolation_policy" ON "Payslip"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for DriverAttendance
ALTER TABLE "DriverAttendance" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "DriverAttendance" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "DriverAttendance";
CREATE POLICY "tenant_isolation_policy" ON "DriverAttendance"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for DriverScore
ALTER TABLE "DriverScore" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "DriverScore" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "DriverScore";
CREATE POLICY "tenant_isolation_policy" ON "DriverScore"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for FleetKpiSnapshot
ALTER TABLE "FleetKpiSnapshot" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "FleetKpiSnapshot" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "FleetKpiSnapshot";
CREATE POLICY "tenant_isolation_policy" ON "FleetKpiSnapshot"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "Claim";
CREATE POLICY "tenant_isolation_policy" ON "Claim"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "WorkOrder";
CREATE POLICY "tenant_isolation_policy" ON "WorkOrder"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for IntelligencePrediction
ALTER TABLE "IntelligencePrediction" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "IntelligencePrediction" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "IntelligencePrediction";
CREATE POLICY "tenant_isolation_policy" ON "IntelligencePrediction"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for IntelligencePredictionHistory
ALTER TABLE "IntelligencePredictionHistory" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "IntelligencePredictionHistory" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "IntelligencePredictionHistory";
CREATE POLICY "tenant_isolation_policy" ON "IntelligencePredictionHistory"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for IntelligenceVehicleHealth
ALTER TABLE "IntelligenceVehicleHealth" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "IntelligenceVehicleHealth" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "IntelligenceVehicleHealth";
CREATE POLICY "tenant_isolation_policy" ON "IntelligenceVehicleHealth"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for IntelligenceRiskAssessment
ALTER TABLE "IntelligenceRiskAssessment" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "IntelligenceRiskAssessment" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "IntelligenceRiskAssessment";
CREATE POLICY "tenant_isolation_policy" ON "IntelligenceRiskAssessment"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for IntelligenceRecommendation
ALTER TABLE "IntelligenceRecommendation" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "IntelligenceRecommendation" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "IntelligenceRecommendation";
CREATE POLICY "tenant_isolation_policy" ON "IntelligenceRecommendation"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for IntelligenceModelMetrics
ALTER TABLE "IntelligenceModelMetrics" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "IntelligenceModelMetrics" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "IntelligenceModelMetrics";
CREATE POLICY "tenant_isolation_policy" ON "IntelligenceModelMetrics"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
...
-- RLS for EmergencyAlert
ALTER TABLE "EmergencyAlert" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "EmergencyAlert" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "tenant_isolation_policy" ON "EmergencyAlert";
CREATE POLICY "tenant_isolation_policy" ON "EmergencyAlert"
AS PERMISSIVE FOR ALL
USING (
  current_setting('app.bypass_rls', true) = 'on'
  OR "companyId" = current_setting('app.current_company_id', true)
