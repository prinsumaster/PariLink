...
var WebhookController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('webhooks'), (0, common_1.Controller)('webhooks/v1')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _receiveWebhook_decorators;
    var WebhookController = _classThis = /** @class */ (function () {
        function WebhookController_1(prisma, crypto) {
        ...
        WebhookController_1.prototype.receiveWebhook = function (provider, connectionId, signature, payload, req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.log("Received webhook from ".concat(provider, " for connection ").concat(connectionId));
                                    ...
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, tx.webhookDelivery.create({
                                                data: {
                                                    ...
                                                    direction: 'INCOMING',
                                                    endpointUrl: req.url,
                                                    eventTopic: payload.event_type || 'unknown_event',
                                                    payload: payload,
                                                },
                                            })];
                                    });
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, { status: 'Received', timestamp: new Date() }];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _receiveWebhook_decorators = [(0, common_1.Post)('incoming/:provider/:connectionId'), (0, swagger_1.ApiOperation)({
                summary: 'Receive incoming webhooks from external providers',
            })];
        __esDecorate(_classThis, null, _receiveWebhook_decorators, { kind: "method", name: "receiveWebhook", static: false, private: false, access: { has: function (obj) { return "receiveWebhook" in obj; }, get: function (obj) { return obj.receiveWebhook; } }, metadata: _metadata }, null, _instanceExtraInitializers);
