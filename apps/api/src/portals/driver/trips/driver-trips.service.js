...
var DriverTripsService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var DriverTripsService = _classThis = /** @class */ (function () {
        function DriverTripsService_1(prisma) {
            this.prisma = prisma;
            this.logger = new common_1.Logger(DriverTripsService.name);
        }
        DriverTripsService_1.prototype.getActiveTrip = function (companyId, driverId) {
        ...
        DriverTripsService_1.prototype.updateTripStatus = function (companyId, driverId, tripId, status, location) {
            return __awaiter(this, void 0, void 0, function () {
                var trip;
                var _this = this;
                return __generator(this, function (_a) {
        ...
        return DriverTripsService_1;
    }());
    __setFunctionName(_classThis, "DriverTripsService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        DriverTripsService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DriverTripsService = _classThis;
}();
