...
var crypto_service_1 = require("./common/services/crypto.service");
var dlp_guard_1 = require("./common/guards/dlp.guard");
var SecurityModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            providers: [crypto_service_1.CryptoService, dlp_guard_1.DlpGuard],
            exports: [crypto_service_1.CryptoService, dlp_guard_1.DlpGuard],
        })];
