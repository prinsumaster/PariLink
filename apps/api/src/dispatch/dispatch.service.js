...
var DispatchService = function () {
    ...
    var _classThis;
    var DispatchService = _classThis = /** @class */ (function () {
        function DispatchService_1(prisma, workflow, eventEmitter, twilioService, auditService, eventStore) {
            this.prisma = prisma;
        ...
        DispatchService_1.prototype.getBoardData = function (companyId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var _a, pendingLoads, availableDrivers, availableVehicles, availableTrailers, activeTrips;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        _a = _b.sent(), pendingLoads = _a[0], availableDrivers = _a[1], availableVehicles = _a[2], availableTrailers = _a[3], activeTrips = _a[4];
                                        return [2 /*return*/, {
        ...
        DispatchService_1.prototype.moveBoardCard = function (companyId, loadId, newStatus, boardPosition) {
            return __awaiter(this, void 0, void 0, function () {
                var updatedLoad;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                var existingLoad, ruleResult, load;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            if (!existingLoad) {
                                                throw new common_1.BadRequestException('Load not found');
                                            }
                                            return [4 /*yield*/, this.workflow.evaluateRules(companyId, {
                                                    entityType: 'DISPATCH',
                                                    trigger: 'BOARD_CARD_MOVED',
                                                    entityData: { load: existingLoad, newStatus: newStatus, boardPosition: boardPosition },
                                                })];
                                        case 2:
                                            ruleResult = _a.sent();
                                            if (ruleResult.triggeredActions.some(function (a) { return a.actionType === 'REJECT'; })) {
                                                throw new common_1.BadRequestException('Dispatch move rejected by business rules.');
                                            }
                                            return [4 /*yield*/, this.prisma.updateWithOcc(tx, 'load', loadId, existingLoad.updatedAt, { status: newStatus, boardPosition: boardPosition })];
                                        case 3:
                                            load = _a.sent();
                                            return [4 /*yield*/, this.auditService.logEvent({
                                                    ...
                                                    afterValue: { status: newStatus, boardPosition: boardPosition },
                                                    source: 'API',
                                                }, null, tx)];
                                        case 4:
                                            _a.sent();
                                            return [4 /*yield*/, this.eventStore.append({
                                                    ...
                                                    payload: { status: newStatus, boardPosition: boardPosition },
                                                })];
                                        case 5:
                                            _a.sent();
        ...
        return DispatchService_1;
    }());
    __setFunctionName(_classThis, "DispatchService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        DispatchService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DispatchService = _classThis;
}();
