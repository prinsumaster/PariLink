...
var CommentsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Comments'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('comments')];
    ...
    var CommentsController = _classThis = /** @class */ (function () {
        ...
        CommentsController_1.prototype.getComments = function (user, entityType, entityId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.commentsService.getComments(user.companyId, entityType, entityId)];
                });
            });
        };
        CommentsController_1.prototype.addComment = function (user, entityType, entityId, body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.commentsService.addComment(user.companyId, user.userId, entityType, entityId, body.content, body.parentId)];
                });
            });
        };
        CommentsController_1.prototype.deleteComment = function (user, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.commentsService.deleteComment(user.companyId, user.userId, id)];
                });
            });
        };
    ...
    (function () {
        ...
        _getComments_decorators = [(0, common_1.Get)(':entityType/:entityId'), (0, swagger_1.ApiOperation)({ summary: 'Get comments for an entity' })];
        _addComment_decorators = [(0, common_1.Post)(':entityType/:entityId'), (0, swagger_1.ApiOperation)({ summary: 'Add a comment to an entity' })];
        _deleteComment_decorators = [(0, common_1.Delete)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Delete a comment' })];
