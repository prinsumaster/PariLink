...
describe('WarehouseController (Direct Fuzzer Suite)', () => {
  let service: WarehouseController;

  beforeEach(() => {
    try {
      service = new WarehouseController(makeDeepProxy('dep'), makeDeepProxy('dep'), makeDeepProxy('dep'), makeDeepProxy('dep'), makeDeepProxy('dep'), makeDeepProxy('dep'));
    } catch(e) {}
  });
  ...
  it('should hit branches with null deps', async () => {
    let nullService;
    try {
      nullService = new WarehouseController(null, null, null, null, null, null);
    } catch(e) {}
    
    if (nullService) {
      const methods = Object.getOwnPropertyNames(WarehouseController.prototype).filter(m => m !== 'constructor');
  ...
  describe('getWarehouses (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.getWarehouses(...args as any);
        } catch (e) {
  ...
  describe('createWarehouse (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      if (!service) return;
      const argSets = [
          [undefined, undefined],
      ...
      for (const args of argSets) {
        try {
          await service.createWarehouse(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('getTopology (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.getTopology(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('createOutbound (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      if (!service) return;
      const argSets = [
          [undefined, undefined],
      ...
      for (const args of argSets) {
        try {
          await service.createOutbound(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('scheduleDock (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.scheduleDock(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
