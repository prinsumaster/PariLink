...
var TrailerQueryDto = function () {
    ...
    return _a = /** @class */ (function (_super) {
            __extends(TrailerQueryDto, _super);
            function TrailerQueryDto() {
...
exports.TrailerQueryDto = TrailerQueryDto;
