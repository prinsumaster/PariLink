...
var FuelService = function () {
    ...
    var _classThis;
    var FuelService = _classThis = /** @class */ (function () {
        function FuelService_1(prisma, auditService, eventStore) {
            this.prisma = prisma;
            this.auditService = auditService;
            this.eventStore = eventStore;
        }
        FuelService_1.prototype.createFuelCard = function (companyId, data, userId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx.fuelCard.create({
                                            data: {
                                                companyId: companyId,
        ...
        FuelService_1.prototype.getFuelCards = function (companyId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, tx.fuelCard.findMany({ where: { companyId: companyId } })];
                        }); }); })];
                });
            });
        };
        FuelService_1.prototype.createFuelStation = function (companyId, data, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx.fuelStation.create({
                                            data: {
                                                companyId: companyId,
                                                name: data.name,
        ...
        FuelService_1.prototype.getFuelStations = function (companyId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, tx.fuelStation.findMany({ where: { companyId: companyId } })];
                        }); }); })];
                });
            });
        };
        FuelService_1.prototype.logFuelTransaction = function (companyId, data, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var anomalyDetected, txRecord;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, tx.fuelTransaction.create({
                                                data: {
                                                    companyId: companyId,
                                                    vehicleId: data.vehicleId,
                                                    driverId: data.driverId,
        ...
        FuelService_1.prototype.getFuelTransactions = function (companyId, vehicleId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                return [2 /*return*/, tx.fuelTransaction.findMany({
                                        where: where,
        ...
        return FuelService_1;
    }());
    __setFunctionName(_classThis, "FuelService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FuelService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FuelService = _classThis;
}();
