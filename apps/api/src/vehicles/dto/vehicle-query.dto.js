...
var VehicleQueryDto = function () {
    ...
    return _a = /** @class */ (function (_super) {
            __extends(VehicleQueryDto, _super);
            function VehicleQueryDto() {
        ...
        (function () {
            ...
            _type_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: ['TRUCK', 'TRAILER', 'VAN'] }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)(['TRUCK', 'TRAILER', 'VAN'])];
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    enum: ['IN_SERVICE', 'MAINTENANCE', 'OUT_OF_SERVICE'],
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)(['IN_SERVICE', 'MAINTENANCE', 'OUT_OF_SERVICE'])];
