    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(prisma) {
            var _this = _super.call(this, {
                ...
                secretOrKey: (0, auth_module_1.getJwtPublicKey)(),
                algorithms: ['RS256'],
            }) || this;
            _this.prisma = prisma;
            _this.logger = new common_1.Logger(JwtStrategy.name);
            return _this;
        }
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!user || user.status !== 'ACTIVE' || user.deletedAt) {
                                console.error('JwtStrategy validation failed!', { user: user });
                                this.logger.warn("[ZeroTrust] Rejected token for deactivated/deleted user ".concat(payload.sub));
                                throw new common_1.UnauthorizedException('User account is inactive or deleted');
                            }
