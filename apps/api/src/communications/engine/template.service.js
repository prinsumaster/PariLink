...
var TemplateService = function () {
    ...
    var TemplateService = _classThis = /** @class */ (function () {
        function TemplateService_1() {
            this.logger = new common_1.Logger(TemplateService.name);
        ...
        TemplateService_1.prototype.render = function (templateString, data) {
            try {
                ...
                this.logger.error("Template rendering failed: ".concat(errorMessage));
