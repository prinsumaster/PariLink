...
var PreferencesController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('preferences'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('preferences/notifications')];
    ...
    var PreferencesController = _classThis = /** @class */ (function () {
        function PreferencesController_1(prisma) {
            this.prisma = (__runInitializers(this, _instanceExtraInitializers), prisma);
        }
        PreferencesController_1.prototype.getPreferences = function (user) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            prefs = _a.sent();
                            _a.label = 3;
                        case 3: return [2 /*return*/, { data: prefs }];
                    }
                });
            });
        };
        PreferencesController_1.prototype.updatePreferences = function (user, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var prefs;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.runAsTenant(user.companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, tx.notificationPreference.update({
                                            where: { userId: user.id },
                                            data: {
    ...
    (function () {
        ...
        _getPreferences_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get user notification preferences' })];
        _updatePreferences_decorators = [(0, common_1.Put)(), (0, swagger_1.ApiOperation)({ summary: 'Update user notification preferences' })];
