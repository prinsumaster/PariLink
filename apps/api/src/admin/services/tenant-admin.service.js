...
var TenantAdminService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var TenantAdminService = _classThis = /** @class */ (function () {
        function TenantAdminService_1(prisma, audit) {
            this.prisma = prisma;
            this.audit = audit;
        }
        TenantAdminService_1.prototype.getTenants = function (status) {
        ...
        TenantAdminService_1.prototype.getTenantById = function (companyId) {
            return __awaiter(this, void 0, void 0, function () {
                var company;
                var _this = this;
                return __generator(this, function (_a) {
        ...
        TenantAdminService_1.prototype.updateTenantStatus = function (companyId, dto, adminUserId) {
            return __awaiter(this, void 0, void 0, function () {
                var company, updated;
                var _this = this;
                return __generator(this, function (_a) {
        ...
        TenantAdminService_1.prototype.updateBranding = function (companyId, dto, adminUserId) {
            return __awaiter(this, void 0, void 0, function () {
                var config, currentTheme, updatedTheme, updated;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, tx.tenantConfiguration.findUnique({
                        ...
                        case 1:
                            config = _a.sent();
                            if (!config)
                                throw new common_1.NotFoundException("Configuration for tenant ".concat(companyId, " not found"));
                            currentTheme = (config.theme || {});
                            updatedTheme = __assign(__assign({}, currentTheme), dto);
                            return [4 /*yield*/, this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
        ...
        TenantAdminService_1.prototype.updateRegional = function (companyId, dto, adminUserId) {
            return __awaiter(this, void 0, void 0, function () {
                var config, currentSettings, updatedSettings, updated;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        case 1:
                            ...
                            updatedSettings = __assign(__assign({}, currentSettings), { regional: __assign(__assign({}, (currentSettings.regional || {})), dto) });
                            return [4 /*yield*/, this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, tx.tenantConfiguration.update({
                                                where: { companyId: companyId },
        ...
        TenantAdminService_1.prototype.updateBusinessHours = function (companyId, dto, adminUserId) {
            return __awaiter(this, void 0, void 0, function () {
                var config, currentSettings, updatedSettings, updated;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!config)
                                throw new common_1.NotFoundException("Configuration for tenant ".concat(companyId, " not found"));
                            currentSettings = (config.settings || {});
                            updatedSettings = __assign(__assign({}, currentSettings), { businessHours: __assign(__assign({}, (currentSettings.businessHours || {})), dto) });
                            return [4 /*yield*/, this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, tx.tenantConfiguration.update({
                                                where: { companyId: companyId },
        ...
        return TenantAdminService_1;
    }());
    __setFunctionName(_classThis, "TenantAdminService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        TenantAdminService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TenantAdminService = _classThis;
}();
