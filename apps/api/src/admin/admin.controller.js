...
var AdminController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Admin'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard), (0, common_1.Controller)('admin')];
    ...
    var AdminController = _classThis = /** @class */ (function () {
        function AdminController_1() {
            this.logger = (__runInitializers(this, _instanceExtraInitializers), new common_1.Logger(AdminController.name));
        }
        AdminController_1.prototype.getAdminDashboard = function () {
    ...
    (function () {
        ...
        _getAdminDashboard_decorators = [(0, common_1.Get)('dashboard'), (0, permissions_decorator_1.RequirePermissions)('system:admin')];
