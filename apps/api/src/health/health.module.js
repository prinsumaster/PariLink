...
var bullmq_health_1 = require("./bullmq.health");
var HealthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                bullmq_1.BullModule.registerQueue({ name: 'background_jobs' }), // Using one core queue for readiness check
            ],
            controllers: [health_controller_1.HealthController],
            providers: [redis_health_1.RedisHealthIndicator, bullmq_health_1.BullMQHealthIndicator],
        })];
