...
var BackupService = function () {
    ...
    var BackupService = _classThis = /** @class */ (function () {
        function BackupService_1(auditService, prisma) {
            this.auditService = auditService;
            this.prisma = prisma;
            this.logger = new common_1.Logger(BackupService.name);
        }
        BackupService_1.prototype.triggerTenantBackup = function (companyId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.log("Initiating isolated tenant backup for company ".concat(companyId));
                        ...
                        case 1:
                            ...
                            // For local implementation, we stub the event.
                            _a.sent();
                            return [2 /*return*/, { success: true, message: 'Backup initiated successfully' }];
                    }
                });
            });
        };
