...
var WorkflowGeneratorService = function () {
    ...
    var WorkflowGeneratorService = _classThis = /** @class */ (function () {
        function WorkflowGeneratorService_1(gemini) {
            this.gemini = gemini;
            this.logger = new common_1.Logger(WorkflowGeneratorService.name);
        }
        WorkflowGeneratorService_1.prototype.generateWorkflowGraph = function (prompt) {
            return __awaiter(this, void 0, void 0, function () {
                var systemInstruction, response, jsonStr, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.log("Generating AI Workflow for prompt: ".concat(prompt));
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.gemini.chat(prompt, systemInstruction)];
                        case 2:
                            response = _a.sent();
                            jsonStr = response
                                .replace(/```json/g, '')
                        ...
                        case 3:
                            e_1 = _a.sent();
                            this.logger.error("AI Workflow generation failed: ".concat(e_1.message));
