...
var RecommendationEngineService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var RecommendationEngineService = _classThis = /** @class */ (function () {
        function RecommendationEngineService_1(prisma, contextEngine, aiProvider) {
            this.prisma = prisma;
         ...
         */
        RecommendationEngineService_1.prototype.generateRecommendation = function (companyId, domainEntity, entityId, promptGoal) {
            return __awaiter(this, void 0, void 0, function () {
                var context, schema, output, recommendation;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.log("Generating Recommendation for ".concat(domainEntity, " [").concat(entityId, "]"));
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.aiProvider.structuredGenerate(promptGoal, context, schema)];
                        case 2:
                            output = _a.sent();
        ...
        return RecommendationEngineService_1;
    }());
