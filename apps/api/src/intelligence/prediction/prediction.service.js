...
var PredictionService = function () {
    ...
    var _classThis;
    var PredictionService = _classThis = /** @class */ (function () {
        function PredictionService_1(prisma) {
            this.prisma = prisma;
            this.logger = new common_1.Logger(PredictionService.name);
        }
        PredictionService_1.prototype.predictEta = function (tripId, currentLat, currentLng, companyId) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.logger.log("Predicting ETA for trip ".concat(tripId));
                            predictedEta = new Date(Date.now() + 3600 * 1000 * 24);
                            return [4 /*yield*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, tx.intelligencePrediction.create({
                                                data: {
                                                    companyId: companyId,
                                                    entityId: tripId,
                                                    entityType: 'TRIP',
