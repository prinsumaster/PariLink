...
var GpsService = function () {
    ...
    var GpsService = _classThis = /** @class */ (function () {
        function GpsService_1(prisma, eventService) {
            this.prisma = prisma;
            this.eventService = eventService;
            this.logger = new common_1.Logger(GpsService.name);
        }
        GpsService_1.prototype.ingestPing = function (companyId, ping) {
            return __awaiter(this, void 0, void 0, function () {
                var vehicle, timestamp, activeTrip;
                var _this = this;
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!vehicle || vehicle.companyId !== companyId) {
                                this.logger.warn("Invalid GPS ping for vehicle ".concat(ping.vehicleId));
                                return [2 /*return*/];
                            }
                        ...
                        case 2:
                            activeTrip = _a.sent();
                            if (!(activeTrip && activeTrip.driverId)) return [3 /*break*/, 4];
                            return [4 /*yield*/, this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                        ...
                        case 5:
                            ...
                            this.eventService.publish('GpsPing.Received', {
                                ...
                                correlationId: "gps-".concat(ping.vehicleId, "-").concat(timestamp.getTime()),
                                payload: ping,
                                timestamp: timestamp,
                            });
