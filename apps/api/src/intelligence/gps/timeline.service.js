...
var TimelineService = function () {
    ...
    var _classThis;
    var TimelineService = _classThis = /** @class */ (function () {
        function TimelineService_1(prisma) {
            this.prisma = prisma;
            this.logger = new common_1.Logger(TimelineService.name);
        }
        TimelineService_1.prototype.addEvent = function (tripId_1, companyId_1, eventName_1) {
            return __awaiter(this, arguments, void 0, function (tripId, companyId, eventName, metadata) {
                var trip, timeline;
                var _this = this;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            this.logger.debug("Timeline event ".concat(eventName, " added to trip ").concat(tripId));
                            return [2 /*return*/];
                    }
                });
            });
        };
        return TimelineService_1;
    }());
    __setFunctionName(_classThis, "TimelineService");
    (function () {
