...
describe('ProfitabilityService (Direct Fuzzer Suite)', () => {
  ...
  describe('calculateTripProfitability (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.calculateTripProfitability(...args as any);
        } catch (e) {
  ...
  describe('calculateCustomerProfitability (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      if (!service) return;
      const argSets = [
      ...
      for (const args of argSets) {
        try {
          await service.calculateCustomerProfitability(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
