...
exports.CommandGateway = void 0;
var websockets_1 = require("@nestjs/websockets");
var common_1 = require("@nestjs/common");
var CommandGateway = function () {
    ...
    var _handleDispatchAction_decorators;
    var CommandGateway = _classThis = /** @class */ (function () {
        function CommandGateway_1(bpm) {
            this.bpm = (__runInitializers(this, _instanceExtraInitializers), bpm);
            this.server = __runInitializers(this, _server_initializers, void 0);
            this.logger = (__runInitializers(this, _server_extraInitializers), new common_1.Logger(CommandGateway.name));
        }
        CommandGateway_1.prototype.handleDispatchAction = function (payload, client) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log("Received dispatch command: ".concat(payload.action, " for vehicle ").concat(payload.vehicleId));
                    ...
                    return [2 /*return*/, { status: 'ACCEPTED' }];
                });
            });
        };
        return CommandGateway_1;
    }());
    __setFunctionName(_classThis, "CommandGateway");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _server_decorators = [(0, websockets_1.WebSocketServer)()];
        _handleDispatchAction_decorators = [(0, websockets_1.SubscribeMessage)('dispatch_action')];
        __esDecorate(_classThis, null, _handleDispatchAction_decorators, { kind: "method", name: "handleDispatchAction", static: false, private: false, access: { has: function (obj) { return "handleDispatchAction" in obj; }, get: function (obj) { return obj.handleDispatchAction; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        CommandGateway = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CommandGateway = _classThis;
}();
