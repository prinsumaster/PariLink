...
var AttendanceController = function () {
    var _classDecorators = [(0, common_1.Controller)('drivers/attendance'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var AttendanceController = _classThis = /** @class */ (function () {
        function AttendanceController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        AttendanceController_1.prototype.create = function (req, data) {
            return this.service.create(req.user.companyId, req.user.id, data);
        };
        AttendanceController_1.prototype.findAll = function (req, query) {
            return this.service.findAll(req.user.companyId, query);
        };
        AttendanceController_1.prototype.findOne = function (req, id) {
            return this.service.findOne(req.user.companyId, id);
        };
        AttendanceController_1.prototype.update = function (req, id, data) {
            return this.service.update(req.user.companyId, id, req.user.id, data);
        };
        AttendanceController_1.prototype.remove = function (req, id) {
