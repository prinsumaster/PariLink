...
var BillingModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [workflow_module_1.WorkflowModule, platform_module_1.PlatformModule],
            controllers: [stripe_controller_1.StripeController, billing_controller_1.BillingController],
            providers: [stripe_service_1.StripeBillingService, billing_service_1.BillingService],
            exports: [stripe_service_1.StripeBillingService, billing_service_1.BillingService],
        })];
