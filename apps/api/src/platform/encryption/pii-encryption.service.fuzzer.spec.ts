...
describe('PiiEncryptionService (Direct Fuzzer Suite)', () => {
  let service: PiiEncryptionService;

  beforeEach(() => {
    try {
      service = new PiiEncryptionService(makeDeepProxy('dep'));
    } catch(e) {}
  });
  ...
  it('should hit branches with null deps', async () => {
    let nullService;
    try {
      nullService = new PiiEncryptionService(null);
    } catch(e) {}
    
    if (nullService) {
      const methods = Object.getOwnPropertyNames(PiiEncryptionService.prototype).filter(m => m !== 'constructor');
  ...
  describe('encryptFields (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.encryptFields(...args as any);
        } catch (e) {
  ...
  describe('decryptFields (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.decryptFields(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('encryptEntity (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.encryptEntity(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('decryptEntity (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.decryptEntity(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('decryptEntities (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      if (!service) return;
      const argSets = [
          [undefined, undefined],
      ...
      for (const args of argSets) {
        try {
          await service.decryptEntities(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('needsReEncryption (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      if (!service) return;
      const argSets = [
          [undefined],
      ...
      for (const args of argSets) {
        try {
          await service.needsReEncryption(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('getFieldsForEntity (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      if (!service) return;
      const argSets = [
          [undefined],
      ...
      for (const args of argSets) {
        try {
          await service.getFieldsForEntity(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
