...
var EventService = function () {
    ...
    var EventService = _classThis = /** @class */ (function () {
        function EventService_1(prisma, eventEmitter) {
            this.prisma = prisma;
            this.eventEmitter = eventEmitter;
            this.logger = new common_1.Logger(EventService.name);
        }
        EventService_1.prototype.publish = function (eventName, event) {
            this.logger.debug("[EventBus] Publishing ".concat(eventName, " for tenant ").concat(event.tenantId));
            this.eventEmitter.emit(eventName, event);
        };
        EventService_1.prototype.publishAsync = function (eventName, event) {
            this.logger.debug("[EventBus] Publishing async ".concat(eventName, " for tenant ").concat(event.tenantId));
         ...
         */
        EventService_1.prototype.publishOutbox = function (event, prismaTx) {
            return __awaiter(this, void 0, void 0, function () {
                var db;
                return __generator(this, function (_a) {
                    this.logger.debug("[EventBus/Outbox] Storing event ".concat(event.type, " for tenant ").concat(event.tenantId));
                    db = prismaTx || this.prisma;
                    return [2 /*return*/, db.domainEvent.create({
                            data: {
                                id: event.id,
