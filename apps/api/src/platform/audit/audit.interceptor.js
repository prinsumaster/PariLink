...
var AuditInterceptor = function () {
    ...
    var AuditInterceptor = _classThis = /** @class */ (function () {
        function AuditInterceptor_1(auditService) {
        ...
        AuditInterceptor_1.prototype.intercept = function (context, next) {
            ...
            return next.handle().pipe((0, operators_1.tap)(function (data) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    switch (_b.label) {
                        case 0:
                            if (!req.user || !req.user.companyId)
                                return [2 /*return*/];
                            entityId = ((_a = req.params) === null || _a === void 0 ? void 0 : _a.id) || (data === null || data === void 0 ? void 0 : data.id) || 'UNKNOWN';
                            entityType = this.inferEntityType(req.url);
        ...
        AuditInterceptor_1.prototype.mapMethodToAction = function (method) {
            switch (method) {
                case 'POST':
                    return 'CREATE';
                case 'PUT':
        ...
        AuditInterceptor_1.prototype.inferEntityType = function (url) {
            var parts = url
                .split('?')[0]
                .split('/')
            ...
            var relevantPart = parts.length > 2
                ? parts[parts.length -
                    (url.includes(':id') ||
