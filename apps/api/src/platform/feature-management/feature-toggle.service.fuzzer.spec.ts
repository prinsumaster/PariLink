...
describe('FeatureToggleService (Direct Fuzzer Suite)', () => {
  let service: FeatureToggleService;

  beforeEach(() => {
    try {
      service = new FeatureToggleService(makeDeepProxy('dep'), makeDeepProxy('dep'));
    } catch(e) {}
  });
  ...
  it('should hit branches with null deps', async () => {
    let nullService;
    try {
      nullService = new FeatureToggleService(null, null);
    } catch(e) {}
    
    if (nullService) {
      const methods = Object.getOwnPropertyNames(FeatureToggleService.prototype).filter(m => m !== 'constructor');
  ...
  describe('isEnabled (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.isEnabled(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('enable (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.enable(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('killSwitch (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.killSwitch(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
  ...
  describe('invalidate (Fuzzer)', () => {
    it('should handle fuzzing gracefully', async () => {
      ...
      for (const args of argSets) {
        try {
          await service.invalidate(...args as any);
        } catch (e) {
          // ignore error for fuzzing
        }
      }
