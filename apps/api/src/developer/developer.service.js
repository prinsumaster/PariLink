...
var DeveloperService = function () {
    ...
    var DeveloperService = _classThis = /** @class */ (function () {
        function DeveloperService_1(prisma, audit) {
            this.prisma = prisma;
            this.audit = audit;
        }
        DeveloperService_1.prototype.generateClientSecret = function () {
            return 'sk_dev_' + crypto.randomBytes(32).toString('hex');
        };
        DeveloperService_1.prototype.createApp = function (companyId, userId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var clientId, clientSecret, app;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            clientId = 'ca_' + crypto.randomBytes(16).toString('hex');
                            clientSecret = this.generateClientSecret();
                            return [4 /*yield*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, tx.developerApp.create({
                                                data: {
                                                    companyId: companyId,
                                                    name: dto.name,
        ...
        DeveloperService_1.prototype.getApp = function (companyId, id) {
            return __awaiter(this, void 0, void 0, function () {
                var app;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, tx.developerApp.findUnique({
                        ...
                        case 1:
                            ...
                            if (!app || app.companyId !== companyId) {
                                throw new common_1.NotFoundException('Developer Application not found');
                            }
                            return [2 /*return*/, app];
                    }
                });
        ...
        DeveloperService_1.prototype.updateApp = function (companyId, id, userId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var app, updated;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getApp(companyId, id)];
                        case 1:
                            app = _a.sent();
                            return [4 /*yield*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, tx.developerApp.update({
                                                where: { id: id, companyId: companyId },
                                                data: {
                                                    name: dto.name,
                                                    description: dto.description,
        ...
        DeveloperService_1.prototype.rotateSecret = function (companyId, id, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var app, newSecret, updated;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getApp(companyId, id)];
                        ...
                        case 3:
                            _a.sent();
                            return [2 /*return*/, { clientSecret: updated.clientSecret }];
                    }
                });
            });
        };
        DeveloperService_1.prototype.deleteApp = function (companyId, id, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var app;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                    return [2 /*return*/, tx.developerApp.delete({ where: { id: id, companyId: companyId } })];
                                }); }); })];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, this.audit.logEvent({
