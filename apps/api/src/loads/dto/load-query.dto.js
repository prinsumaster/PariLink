...
var LoadQueryDto = function () {
    ...
    return _a = /** @class */ (function (_super) {
            __extends(LoadQueryDto, _super);
            function LoadQueryDto() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.status = __runInitializers(_this, _status_initializers, void 0);
                _this.customerId = (__runInitializers(_this, _status_extraInitializers), __runInitializers(_this, _customerId_initializers, void 0));
                __runInitializers(_this, _customerId_extraInitializers);
                return _this;
            }
            return LoadQueryDto;
        }(_classSuper)),
        (function () {
            ...
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({
                ...
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)(['PENDING', 'ASSIGNED', 'IN_TRANSIT', 'DELIVERED', 'CANCELLED'])];
            _customerId_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsUUID)()];
...
exports.LoadQueryDto = LoadQueryDto;
