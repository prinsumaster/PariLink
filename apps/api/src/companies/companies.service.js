...
var CompaniesService = function () {
    ...
    var CompaniesService = _classThis = /** @class */ (function () {
        function CompaniesService_1(prisma, auditService, eventStore) {
            this.prisma = prisma;
            this.auditService = auditService;
            this.eventStore = eventStore;
        }
        CompaniesService_1.prototype.create = function (createCompanyDto, userId) {
        ...
        CompaniesService_1.prototype.findAll = function (query, companyId) {
            return __awaiter(this, void 0, void 0, function () {
                        ...
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.all([
                                    ...
                                    this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                        return [2 /*return*/, tx.company.count({ where: where })];
                                    }); }); }),
                                ])];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, tx.company.findFirst({
                                            where: { id: id },
                                        })];
                                });
                            }); })];
        ...
        CompaniesService_1.prototype.update = function (id, updateCompanyDto, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent(); // verify existence
                            return [2 /*return*/, this.prisma.runAsSystem('System operation or legacy bypass', function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    var company;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, tx.company.update({
                                                    where: { id: id },
        ...
        CompaniesService_1.prototype.remove = function (id, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
