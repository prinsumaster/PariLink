...
describe('ExecutionService (Direct Fuzzer Suite)', () => {
  let service: ExecutionService;

  beforeEach(() => {
    try {
      service = new ExecutionService(makeDeepProxy('dep'), makeDeepProxy('dep'), makeDeepProxy('dep'));
    } catch(e) {}
  });
  ...
  it('should hit branches with null deps', async () => {
    let nullService;
    try {
      nullService = new ExecutionService(null, null, null);
    } catch(e) {}
