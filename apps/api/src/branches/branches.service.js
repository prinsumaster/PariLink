...
var BranchesService = function () {
    ...
    var _classThis;
    var BranchesService = _classThis = /** @class */ (function () {
        function BranchesService_1(prisma) {
            this.prisma = prisma;
        }
        BranchesService_1.prototype.create = function (companyId, createBranchDto) {
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                ...
                                return [2 /*return*/, tx.branch.create({
                                        data: __assign(__assign({}, createBranchDto), { companyId: companyId }),
                                    })];
                            });
                        }); })];
                });
        ...
        BranchesService_1.prototype.findAll = function (companyId, query) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
        ...
        BranchesService_1.prototype.findOne = function (companyId, id) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx.branch.findFirst({
                                            where: { id: id, companyId: companyId },
                                        })];
                                    case 1:
                                        branch = _a.sent();
                                        if (!branch) {
                                            throw new common_1.NotFoundException("Branch with ID ".concat(id, " not found"));
                                        }
        ...
        BranchesService_1.prototype.update = function (companyId, id, updateBranchDto) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [2 /*return*/, tx.branch.update({
                                                where: { id: id, companyId: companyId },
        ...
        BranchesService_1.prototype.remove = function (companyId, id) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return BranchesService_1;
    }());
    __setFunctionName(_classThis, "BranchesService");
    (function () {
