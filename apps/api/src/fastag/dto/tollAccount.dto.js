...
exports.QueryTollAccountDto = exports.UpdateTollAccountDto = exports.CreateTollAccountDto = void 0;
var class_validator_1 = require("class-validator");
var CreateTollAccountDto = function () {
    var _a;
    var _id_decorators;
...
exports.CreateTollAccountDto = CreateTollAccountDto;
var UpdateTollAccountDto = function () {
    var _a;
    var _status_decorators;
    var _status_initializers = [];
    var _status_extraInitializers = [];
...
exports.UpdateTollAccountDto = UpdateTollAccountDto;
var QueryTollAccountDto = function () {
    var _a;
    var _status_decorators;
    var _status_initializers = [];
    var _status_extraInitializers = [];
    ...
    return _a = /** @class */ (function () {
            function QueryTollAccountDto() {
                this.status = __runInitializers(this, _status_initializers, void 0);
                this.search = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _search_initializers, void 0));
                this.skip = (__runInitializers(this, _search_extraInitializers), __runInitializers(this, _skip_initializers, void 0));
            ...
            return QueryTollAccountDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _status_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _search_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _skip_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _take_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            __esDecorate(null, null, _status_decorators, { kind: "field", name: "status", static: false, private: false, access: { has: function (obj) { return "status" in obj; }, get: function (obj) { return obj.status; }, set: function (obj, value) { obj.status = value; } }, metadata: _metadata }, _status_initializers, _status_extraInitializers);
...
exports.QueryTollAccountDto = QueryTollAccountDto;
