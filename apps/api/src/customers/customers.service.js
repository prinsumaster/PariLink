...
var CustomersService = function () {
    ...
    var CustomersService = _classThis = /** @class */ (function () {
        function CustomersService_1(prisma) {
            this.prisma = prisma;
        }
        CustomersService_1.prototype.create = function (companyId, createCustomerDto) {
                    ...
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                return [2 /*return*/, tx.customer.create({
                                        data: __assign(__assign({}, createCustomerDto), { companyId: companyId }),
                                    })];
                            });
                        }); })];
                });
        ...
        CustomersService_1.prototype.findAll = function (companyId, query) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
        ...
        CustomersService_1.prototype.findOne = function (companyId, id) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        customer = _a.sent();
                                        if (!customer) {
                                            throw new common_1.NotFoundException("Customer with ID ".concat(id, " not found"));
                                        }
        ...
        CustomersService_1.prototype.update = function (companyId, id, updateCustomerDto) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var existingCustomer, updateResult, updatedCustomer;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx.customer.findFirst({
                                            where: { id: id, companyId: companyId },
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, tx.customer.updateMany({
                                                where: { id: id, companyId: companyId, updatedAt: existingCustomer.updatedAt },
                                                data: updateCustomerDto,
                                            })];
                                    case 2:
                                        updateResult = _a.sent();
                                        if (updateResult.count === 0) {
                                            throw new common_1.ConflictException('Customer was modified by another user. Please refresh and try again.');
                                        }
        ...
        CustomersService_1.prototype.remove = function (companyId, id) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (!existingCustomer)
                                            throw new common_1.NotFoundException();
                                        return [2 /*return*/, tx.customer.updateMany({
                                                where: { id: id, companyId: companyId },
