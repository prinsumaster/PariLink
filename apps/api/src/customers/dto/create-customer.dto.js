...
var CreateCustomerDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateCustomerDto() {
                ...
                this.paymentTerms = (__runInitializers(this, _taxId_extraInitializers), __runInitializers(this, _paymentTerms_initializers, void 0));
                this.creditLimit = (__runInitializers(this, _paymentTerms_extraInitializers), __runInitializers(this, _creditLimit_initializers, void 0));
                this.status = (__runInitializers(this, _creditLimit_extraInitializers), __runInitializers(this, _status_initializers, void 0));
        ...
        (function () {
            ...
            _code_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'ACME-001' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _email_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'billing@acme.com' }), (0, class_validator_1.IsEmail)(), (0, class_validator_1.IsOptional)()];
            ...
            _billingAddress_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: '123 Business Rd, Dallas, TX' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _taxId_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'XX-XXXXXXX' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _paymentTerms_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    enum: ['NET_15', 'NET_30', 'NET_60', 'DUE_ON_RECEIPT'],
                    default: 'NET_30',
                }), (0, class_validator_1.IsIn)(['NET_15', 'NET_30', 'NET_60', 'DUE_ON_RECEIPT']), (0, class_validator_1.IsOptional)()];
            _creditLimit_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 50000 }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(0)];
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    enum: ['ACTIVE', 'INACTIVE', 'CREDIT_HOLD'],
                    default: 'ACTIVE',
                }), (0, class_validator_1.IsIn)(['ACTIVE', 'INACTIVE', 'CREDIT_HOLD']), (0, class_validator_1.IsOptional)()];
