...
var SupportController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Support'), (0, common_1.Controller)('support'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var SupportController = _classThis = /** @class */ (function () {
        function SupportController_1() {
            this.logger = (__runInitializers(this, _instanceExtraInitializers), new common_1.Logger(SupportController.name));
        }
        SupportController_1.prototype.createTicket = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log("Received support ticket: ".concat(payload.subject));
                    // Scaffolded: Push to Zendesk or Linear API
                    return [2 /*return*/, { success: true, ticketId: 'TKT-1001', status: 'OPEN' }];
                });
            });
        };
    ...
    (function () {
        ...
        _createTicket_decorators = [(0, common_1.Post)('ticket')];
