...
var AccountsPayableService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var AccountsPayableService = _classThis = /** @class */ (function () {
        function AccountsPayableService_1(prisma) {
            this.prisma = prisma;
            this.logger = new common_1.Logger(AccountsPayableService.name);
        }
        AccountsPayableService_1.prototype.processPayment = function (companyId, invoiceId, amount, method) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.prisma.runAsTenant(companyId, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                    var invoiceUpdate, payment;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, tx.invoice.updateMany({
                                                    where: { id: invoiceId, companyId: companyId, status: { not: 'PAID' } },
                                                    data: { status: 'PAID' },
                                                })];
                                            case 1:
                                                invoiceUpdate = _a.sent();
                                                if (invoiceUpdate.count === 0) {
                                                    throw new common_1.BadRequestException('Invoice is already paid or does not exist');
                                                }
        ...
        AccountsPayableService_1.prototype.getPayments = function (companyId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return AccountsPayableService_1;
    }());
