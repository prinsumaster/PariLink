...
async function main() {
  ...
  console.log("\n=== ATTACK 4: Cross-Tenant DELETE Customer ===");
  const res4 = await client.delete(`${API_URL}/customers/${compA.entities.customerId}`);
  console.log(`DELETE /customers/${compA.entities.customerId} -> Status: ${res4.status}`);
